...
@Component({
  selector: "app-root",
  standalone: true,
  imports: [RouterModule,MainPageComponent,FormsModule, AdminControlComponent, DonListPhyComponent, ShowUserComponent, AddArticleComponent, ShowArticleComponent, PhAddComponent, PhShowComponent, DonArgentComponent, DonComponent, LoginComponent, NewaccComponent, HeaderComponent, ResetpassComponent, GetCardComponent, IconArticleComponent, ArtListComponent, DonListMonComponent, MainPageComponent,AboutUsComponent,ElementsComponent,FooterComponent,FormationComponent],
